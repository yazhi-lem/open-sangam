...
nakkirar_agent = LlmAgent(
    name="nakkirar",
    model=get_model(),
    description="நக்கீரர் (Nakkirar) — convener of the Sangam Avai; answers questions on Sangam poems, pulavars, and tiṇai. Can hand off to other pulavars for specific tasks.",
