...
export const POEMS = [
  ...
  },
  {
    ...
    tinai: ['kurinji', 'mullai', 'marutam', 'neytal', 'palai'],
    available: true,
    loader: () => import('@data/texts/kurunthokai/kurunthokai.json'),
  },
  {
    id: 'ainkurunooru',
  ...
  },
  {
    ...
    collection: '8thokai',
    count: 149, unit: 'poems',
    tinai: ['kurinji', 'mullai', 'marutam', 'neytal', 'palai'],
    available: true,
    loader: () => import('@data/texts/kalithokai/kalithokai.json'),
  },
  {
    id: 'akananooru',
    ta: 'அகநானூறு', en: 'Akananooru',
    collection: '8thokai',
    count: 220, unit: 'poems',
    tinai: ['kurinji', 'mullai', 'marutam', 'neytal', 'palai'],
    available: true,
    loader: () => import('@data/texts/akananooru/akananooru.json'),
  },
  {
    id: 'pathitrupathu',
    ...
    tinai: ['puram'],
    available: true,
    loader: () => import('@data/texts/pathitrupathu/pathitrupathu.json'),
  },
  {
    id: 'purananooru',
  ...
  },
  {
    ...
    available: true,
    loader: () => import('@data/texts/paripadal/paripadal.json'),
  },
  ...
  },
  {
    ...
    available: true,
    loader: () => import('@data/texts/sirupanatrupadai/sirupanatrupadai.json'),
  },
  {
    ...
    available: true,
    loader: () => import('@data/texts/perumpanatrupadai/perumpanatrupadai.json'),
  },
  {
    id: 'malaipadukadam',
    ...
    available: true,
    loader: () => import('@data/texts/malaipadukadam/malaipadukadam.json'),
  },
  {
    id: 'maduraikanchi',
  ...
  },
  {
    ...
    available: true,
    loader: () => import('@data/texts/kurinjipattu/kurinjipattu.json'),
  },
  {
    id: 'pattinappalai',
    ...
    available: true,
    loader: () => import('@data/texts/pattinappalai/pattinappalai.json'),
  },
  {
    id: 'mullaippattu',
    ...
    available: true,
    loader: () => import('@data/texts/mullaippattu/mullaippattu.json'),
  },
  {
    id: 'nedunalvadai',
